...
define amdgpu_ps void @image_store_v2f16(<8 x i32> inreg %rsrc, i32 %s, i32 %t, <2 x half> %in) {
  ...
  ; UNPACKED-NEXT:   [[BUILD_VECTOR1:%[0-9]+]]:_(<2 x i32>) = G_BUILD_VECTOR [[COPY8]](i32), [[COPY9]](i32)
  ; UNPACKED-NEXT:   [[BITCAST:%[0-9]+]]:_(f32) = G_BITCAST [[COPY10]](<2 x f16>)
  ; UNPACKED-NEXT:   [[BITCAST1:%[0-9]+]]:_(i32) = G_BITCAST [[BITCAST]](f32)
  ...
  ; GFX81-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<2 x i32>) = G_BUILD_VECTOR [[BITCAST]](i32), [[DEF]](i32)
...
define amdgpu_ps void @image_store_v3f16(<8 x i32> inreg %rsrc, i32 %s, i32 %t, <3 x half> %in) {
  ...
  ; UNPACKED-NEXT:   [[BITCAST:%[0-9]+]]:_(f32) = G_BITCAST [[COPY10]](<2 x f16>)
  ; UNPACKED-NEXT:   [[BITCAST1:%[0-9]+]]:_(i32) = G_BITCAST [[BITCAST]](f32)
  ; UNPACKED-NEXT:   [[COPY12:%[0-9]+]]:_(i32) = COPY [[BITCAST1]](i32)
  ; UNPACKED-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 16
  ; UNPACKED-NEXT:   [[LSHR:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST1]], [[C]](i32)
  ; UNPACKED-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[LSHR]](i32)
  ; UNPACKED-NEXT:   [[BITCAST2:%[0-9]+]]:_(f32) = G_BITCAST [[COPY11]](<2 x f16>)
  ; UNPACKED-NEXT:   [[BITCAST3:%[0-9]+]]:_(i32) = G_BITCAST [[BITCAST2]](f32)
  ; UNPACKED-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[BITCAST3]](i32)
  ; UNPACKED-NEXT:   [[BUILD_VECTOR1:%[0-9]+]]:_(<2 x i32>) = G_BUILD_VECTOR [[COPY8]](i32), [[COPY9]](i32)
  ; UNPACKED-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<3 x i32>) = G_BUILD_VECTOR [[COPY12]](i32), [[COPY13]](i32), [[COPY14]](i32)
  ...
  ; GFX81-NEXT:   [[BITCAST:%[0-9]+]]:_(f32) = G_BITCAST [[COPY10]](<2 x f16>)
  ; GFX81-NEXT:   [[BITCAST1:%[0-9]+]]:_(i32) = G_BITCAST [[BITCAST]](f32)
  ; GFX81-NEXT:   [[COPY12:%[0-9]+]]:_(i32) = COPY [[BITCAST1]](i32)
  ; GFX81-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 16
  ; GFX81-NEXT:   [[LSHR:%[0-9]+]]:_(i32) = G_LSHR [[BITCAST1]], [[C]](i32)
  ; GFX81-NEXT:   [[COPY13:%[0-9]+]]:_(i32) = COPY [[LSHR]](i32)
  ; GFX81-NEXT:   [[BITCAST2:%[0-9]+]]:_(f32) = G_BITCAST [[COPY11]](<2 x f16>)
  ; GFX81-NEXT:   [[BITCAST3:%[0-9]+]]:_(i32) = G_BITCAST [[BITCAST2]](f32)
  ; GFX81-NEXT:   [[COPY14:%[0-9]+]]:_(i32) = COPY [[BITCAST3]](i32)
  ; GFX81-NEXT:   [[BUILD_VECTOR1:%[0-9]+]]:_(<2 x i32>) = G_BUILD_VECTOR [[COPY8]](i32), [[COPY9]](i32)
  ; GFX81-NEXT:   [[C1:%[0-9]+]]:_(i32) = G_CONSTANT i32 65535
  ; GFX81-NEXT:   [[AND:%[0-9]+]]:_(i32) = G_AND [[COPY12]], [[C1]]
  ; GFX81-NEXT:   [[SHL:%[0-9]+]]:_(i32) = G_SHL [[COPY13]], [[C]](i32)
  ; GFX81-NEXT:   [[OR:%[0-9]+]]:_(i32) = G_OR [[AND]], [[SHL]]
  ; GFX81-NEXT:   [[BITCAST4:%[0-9]+]]:_(<2 x s16>) = G_BITCAST [[OR]](i32)
  ; GFX81-NEXT:   [[AND1:%[0-9]+]]:_(i32) = G_AND [[COPY14]], [[C1]]
  ...
  ; GFX81-NEXT:   [[BITCAST7:%[0-9]+]]:_(<3 x i32>) = G_BITCAST [[CONCAT_VECTORS]](<6 x s16>)
  ; GFX81-NEXT:   G_AMDGPU_INTRIN_IMAGE_STORE_D16 intrinsic(@llvm.amdgcn.image.store.2d), [[BITCAST7]](<3 x i32>), 7, [[BUILD_VECTOR1]](<2 x i32>), $noreg, [[BUILD_VECTOR]](<8 x i32>), 0, 0, 0 :: (dereferenceable store (<3 x f16>), align 8, addrspace 8)
  ; GFX81-NEXT:   S_ENDPGM 0
  ;
...
define amdgpu_ps void @image_store_v4f16(<8 x i32> inreg %rsrc, i32 %s, i32 %t, <4 x half> %in) {
  ...
  ; UNPACKED-NEXT:   [[BUILD_VECTOR2:%[0-9]+]]:_(<4 x i32>) = G_BUILD_VECTOR [[BITCAST1]](i32), [[LSHR]](i32), [[BITCAST3]](i32), [[LSHR1]](i32)
  ...
  ; GFX81-NEXT:   [[BUILD_VECTOR1:%[0-9]+]]:_(<2 x i32>) = G_BUILD_VECTOR [[COPY8]](i32), [[COPY9]](i32)
  ; GFX81-NEXT:   [[BITCAST:%[0-9]+]]:_(<2 x i32>) = G_BITCAST [[CONCAT_VECTORS]](<4 x f16>)
  ; GFX81-NEXT:   [[UV:%[0-9]+]]:_(i32), [[UV1:%[0-9]+]]:_(i32) = G_UNMERGE_VALUES [[BITCAST]](<2 x i32>)
  ; GFX81-NEXT:   [[DEF:%[0-9]+]]:_(i32) = G_IMPLICIT_DEF
